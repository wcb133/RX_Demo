...
class RootReactor: Reactor {
    ...
    struct State {
        let vcs: [UIViewController.Type] = [ReactorVC.self, RxSwift6VC.self, ViewController.self,
                                            ...
                                            ResolverTestVC.self, DeviceKitVC.self, SwiftDateVC.self, SkeletonViewVC.self, CTMediatorHomeVC.self, CodableDemoVC.self, blockVC.self, VarIsOrNotThreadSafeVC.self, RefCountTestVC.self, ThreadLockVC.self]
